...
The following examples are taken from the [`examples_0.ipynb`](https://github.com/mowillia/largeNKP/blob/main/examples_0.ipynb) file. Run the entire file to reproduce all of the results below. 
